...
\addplot[vizorange, line width=1.2pt, dash pattern=on 4pt off 2.2pt]
  coordinates {(8.72,31.8) (12,31.8)};
\addlegendentry{model prediction, post-nerf (31.8\%)}
...
probe-biased evolution run, given only pre-nerf decks, predicts a
collapse to 31.8\% (orange). Hunter's class share (gray) never
leaves its noise band.}
