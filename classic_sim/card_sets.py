...
def get_classic_cards():
  ...
  dire_wolf_alpha = Card(name="Dire Wolf Alpha", card_type=CardTypes.MINION, mana=2, attack=2, health=2, effect=ChangeStats(value=(1,0), trigger=Triggers.AURA, method=Methods.ADJACENT, target=Targets.MINIONS, owner_filter=OwnerFilters.FRIENDLY, type_filter=CreatureTypes.ALL)) #gives all minions +1 including self, nerf attack by 1, mana by 1?
