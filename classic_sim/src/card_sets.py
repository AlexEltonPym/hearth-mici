...
def get_hero_power(hero_class):
  ...
  armor_up = Card(name="Armor Up!", card_type=CardTypes.HERO_POWER, collectable=False, manacost=2,\
                  effect=GainArmor(value=ConstantInt(2), method=Methods.ALL, owner_filter=OwnerFilters.FRIENDLY))
...
def get_basic_cards():
  ...
  elven_archer = Card(name="Elven Archer", card_type=CardTypes.MINION, manacost=1, attack=1, health=1,\
                      effect=DealDamage(value=ConstantInt(1), trigger=Triggers.BATTLECRY, method=Methods.TARGETED, owner_filter=OwnerFilters.ALL, target=Targets.MINION_OR_HERO))
  ...
  grimscale_oracle = Card(name="Grimscale Oracle", card_type=CardTypes.MINION, creature_type=CreatureTypes.MURLOC, manacost=1, attack=1, health=1,\
                          effect=ChangeStats(value=(ConstantInt(1),ConstantInt(0)), method=Methods.ALL, trigger=Triggers.AURA, owner_filter=OwnerFilters.ALL, target=Targets.MINION, type_filter=CreatureTypes.MURLOC))
  ...
  voodoo_doctor = Card(name="Voodoo Doctor", card_type=CardTypes.MINION, manacost=1, attack=2, health=1,\
                       effect=RestoreHealth(value=ConstantInt(2),trigger=Triggers.BATTLECRY, method=Methods.TARGETED, owner_filter=OwnerFilters.ALL, target=Targets.MINION_OR_HERO))
  # Basic two drops
  ...
  murloc_tidehunter = Card(name="Murloc Tidehunter", card_type=CardTypes.MINION, manacost=2, attack=2, health=1, creature_type=CreatureTypes.MURLOC,\
                           ...
                           value=(ConstantInt(1), ConstantCard(Card(name="Murloc Scout", collectable=False, card_type=CardTypes.MINION, manacost=0, attack=1, health=1, creature_type=CreatureTypes.MURLOC)))))
  novice_engineer = Card(name="Novice Engineer", card_type=CardTypes.MINION, manacost=2, attack=1, health=1,\
                         effect=DrawCards(value=ConstantInt(1), trigger=Triggers.BATTLECRY, method=Methods.ALL, owner_filter=OwnerFilters.FRIENDLY))
  ...
  raid_leader = Card(name="Raid Leader", card_type=CardTypes.MINION, manacost=3, attack=2, health=2,\
                     effect=ChangeStats(value=(ConstantInt(1),ConstantInt(0)), trigger=Triggers.AURA, method=Methods.ALL, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY))
  razorfen_hunter = Card(name="Razorfen Hunter", card_type=CardTypes.MINION, manacost=3, attack=2, health=3,\
                           effect=SummonToken(trigger=Triggers.BATTLECRY, method=Methods.ALL, owner_filter=OwnerFilters.FRIENDLY,\
                           value=(ConstantInt(1), ConstantCard(Card(name="Boar", collectable=False, card_type=CardTypes.MINION, manacost=1, attack=1, health=1, creature_type=CreatureTypes.BEAST)))))
  shattered_sun_cleric = Card(name="Shattered Sun Cleric", card_type=CardTypes.MINION, manacost=3, attack=3, health=2,\
                              effect=ChangeStats(value=(ConstantInt(1),ConstantInt(1)), trigger=Triggers.BATTLECRY, method=Methods.TARGETED, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY, duration=Durations.PERMANENTLY))
  ...
  dragonling_mechanic = Card(name="Dragonling Mechanic", card_type=CardTypes.MINION, manacost=4, attack=2, health=4,\
                             effect=SummonToken(trigger=Triggers.BATTLECRY, method=Methods.ALL, owner_filter=OwnerFilters.FRIENDLY,\
                             value=(ConstantInt(1), ConstantCard(Card(name="Mechanical Dragonling", collectable=False, card_type=CardTypes.MINION, manacost=1, attack=2, health=1, creature_type=CreatureTypes.MECH)))))
  ...
  darkscale_healer = Card(name="Darkscale Healer", card_type=CardTypes.MINION, manacost=5, attack=4, health=5,\
                          effect=RestoreHealth(value=ConstantInt(2), trigger=Triggers.BATTLECRY, method=Methods.ALL, target=Targets.MINION_OR_HERO, owner_filter=OwnerFilters.FRIENDLY))
  ...
  gurubashi_berserker = Card(name="Gurubashi Berserker", card_type=CardTypes.MINION, manacost=5, attack=2, health=7,\
                             effect=ChangeStats(value=(ConstantInt(3), ConstantInt(0)), trigger=Triggers.SELF_DAMAGE_TAKEN, method=Methods.SELF, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY, duration=Durations.PERMANENTLY))
  nightblade = Card(name="Nightblade", card_type=CardTypes.MINION, manacost=5, attack=4, health=4,\
                    effect=DealDamage(value=ConstantInt(3), trigger=Triggers.BATTLECRY, method=Methods.ALL, target=Targets.HERO, owner_filter=OwnerFilters.ENEMY))
  stormpike_commando = Card(name="Stormpike Commando", card_type=CardTypes.MINION, manacost=5, attack=4, health=2,\
                            effect=DealDamage(value=ConstantInt(2), trigger=Triggers.BATTLECRY, method=Methods.TARGETED, target=Targets.MINION_OR_HERO, owner_filter=OwnerFilters.ALL))
  ...
  stormwind_champion = Card(name="Stormwind Champion", card_type=CardTypes.MINION, manacost=7, attack=6, health=6,\
                            effect=ChangeStats(value=(ConstantInt(1), ConstantInt(1)), trigger=Triggers.AURA, method=Methods.ALL, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY))
...
def get_common_cards():
  ...
  abusive_sergeant = Card(name="Abusive Sergeant", card_type=CardTypes.MINION, manacost=1, attack=2, health=1,
              effect=ChangeStats(value=(ConstantInt(2), ConstantInt(0)), method=Methods.TARGETED,
  ...
  leper_gnome = Card(name="Leper Gnome", card_type=CardTypes.MINION, manacost=1, attack=2, health=1,
             effect=DealDamage(value=ConstantInt(2), method=Methods.ALL, target=Targets.HERO,
  ...
  young_dragonhawk = Card(name="Young Dragonhawk", card_type=CardTypes.MINION, creature_type=CreatureTypes.BEAST,
  ...
  bloodsail_raider = Card(name="Bloodsail Raider", card_type=CardTypes.MINION, manacost=2, attack=2, health=3, creature_type=CreatureTypes.PIRATE,\
              effect=ChangeStats(trigger=Triggers.BATTLECRY, value=(WeaponAttack(OwnerFilters.FRIENDLY), ConstantInt(0)), method=Methods.SELF, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY, duration=Durations.PERMANENTLY))
      
  dire_wolf_alpha = Card(name="Dire Wolf Alpha", card_type=CardTypes.MINION, creature_type=CreatureTypes.BEAST, manacost=2, attack=2, health=2, effect=ChangeStats(value=(ConstantInt(1), ConstantInt(0)), trigger=Triggers.AURA, method=Methods.ADJACENT,
  ...
  loot_hoarder = Card(name="Loot Hoarder", card_type=CardTypes.MINION, manacost=2, attack=2, health=1,
            effect=DrawCards(value=ConstantInt(1), method=Methods.ALL, owner_filter=OwnerFilters.FRIENDLY, trigger=Triggers.DEATHRATTLE))
  mad_bomber = Card(name="Mad Bomber", card_type=CardTypes.MINION, manacost=2, attack=3, health=2,
            effect=DealDamage(value=ConstantInt(1), random_count=3, method=Methods.RANDOMLY, target=Targets.MINION_OR_HERO,
  ...
  acolyte_of_pain = Card(name="Acolyte of Pain", card_type=CardTypes.MINION, manacost=3, attack=1, health=3,\
                             effect=DrawCards(value=ConstantInt(1), trigger=Triggers.SELF_DAMAGE_TAKEN, method=Methods.ALL, owner_filter=OwnerFilters.FRIENDLY))
  earthen_ring_farseer = Card(name="Earthen Ring Farseer", card_type=CardTypes.MINION, manacost=3, attack=3, health=3,
                effect=RestoreHealth(value=ConstantInt(3), method=Methods.TARGETED, target=Targets.MINION_OR_HERO, owner_filter=OwnerFilters.ALL, trigger=Triggers.BATTLECRY))
  flesheating_ghoul = Card(name="Flesheating Ghoul", card_type=CardTypes.MINION, manacost=3, attack=2, health=3,
               effect=ChangeStats(value=(ConstantInt(1), ConstantInt(0)), method=Methods.SELF, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY, duration=Durations.PERMANENTLY, trigger=Triggers.ANY_MINION_DIES))
  harvest_golem = Card(name="Harvest Golem", card_type=CardTypes.MINION, creature_type=CreatureTypes.MECH, manacost=3, attack=2, health=3,
             effect=SummonToken(value=(ConstantInt(1), ConstantCard(Card(name="Damaged Golem", collectable=False, card_type=CardTypes.MINION, creature_type=CreatureTypes.MECH, manacost=1, attack=2, health=1))),
  ...
  cult_master = Card(name="Cult Master", card_type=CardTypes.MINION, manacost=4, attack=4, health=2,
             effect=DrawCards(value=ConstantInt(1), method=Methods.TARGETED, owner_filter=OwnerFilters.FRIENDLY, trigger=Triggers.FRIENDLY_MINION_DIES))
  ...
  dread_corsair = Card(name="Dread Corsair", card_type=CardTypes.MINION, manacost=4, attack=3, health=3, creature_type=CreatureTypes.PIRATE, attributes=[Attributes.TAUNT],
  ...
  silver_hand_knight = Card(name="Silver Hand Knight", card_type=CardTypes.MINION, manacost=5, attack=4, health=4,
                effect=SummonToken(value=(ConstantInt(1), ConstantCard(Card(name="Squire", collectable=False, card_type=CardTypes.MINION, manacost=1, attack=2, health=2))),
  ...
  spiteful_smith = Card(name="Spiteful Smith", card_type=CardTypes.MINION, manacost=5, attack=4, health=6,
              effect=ChangeStats(value=(IfInt(Damaged(), ConstantInt(2), ConstantInt(0)), ConstantInt(0)), trigger=Triggers.AURA, owner_filter=OwnerFilters.FRIENDLY, target=Targets.WEAPON, method=Methods.ALL))
  ...
  venture_co_mercenary = Card(name="Venture Co. Mercenary", card_type=CardTypes.MINION, manacost=5, attack=7, health=6,
                effect=ChangeCost(value=ConstantInt(3), target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY, method=Methods.ALL, trigger=Triggers.AURA))
  ...
  frost_elemental = Card(name="Frost Elemental", card_type=CardTypes.MINION, creature_type=CreatureTypes.ELEMENTAL, manacost=6, attack=5, health=5,\
            effect=GiveAttribute(value=ConstantAttribute(Attributes.FROZEN), trigger=Triggers.BATTLECRY, method=Methods.TARGETED, target=Targets.MINION_OR_HERO, owner_filter=OwnerFilters.ALL, duration=Durations.PERMANENTLY))
  priestess_of_elune = Card(name="Priestess of Elune", card_type=CardTypes.MINION, manacost=6, attack=5, health=4,\
                  effect=RestoreHealth(value=ConstantInt(4), trigger=Triggers.BATTLECRY, method=Methods.ALL, target=Targets.HERO, owner_filter=OwnerFilters.FRIENDLY))
...
def get_rare_cards():
  ...
  bloodsail_corsair = Card(name="Bloodsail Corsair", card_type=CardTypes.MINION, creature_type=CreatureTypes.PIRATE, manacost=1, attack=1, health=2,\
                           effect=DealDamage(value=ConstantInt(1), trigger=Triggers.BATTLECRY, method=Methods.TARGETED, target=Targets.WEAPON, owner_filter=OwnerFilters.ENEMY))
  
  lightwarden = Card(name="Lightwarden", card_type=CardTypes.MINION, manacost=1, attack=1, health=2,\
                     effect=ChangeStats(value=(ConstantInt(2),ConstantInt(0)), trigger=Triggers.ANY_HEALED, method=Methods.SELF, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY, duration=Durations.PERMANENTLY))
  ...
  murloc_tidecaller = Card(name="Murloc Tidecaller", card_type=CardTypes.MINION, creature_type=CreatureTypes.MURLOC, manacost=1, attack=1, health=2,\
                           effect=ChangeStats(value=(ConstantInt(1),ConstantInt(0)), method=Methods.SELF, trigger=Triggers.FRIENDLY_SAME_TYPE_SUMMONED, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY, duration=Durations.PERMANENTLY))
 
  secretkeeper = Card(name="Secretkeeper", card_type=CardTypes.MINION, manacost=1, attack=1, health=2,\
                      effect=ChangeStats(value=(ConstantInt(1),ConstantInt(1)), trigger=Triggers.ANY_SECRET_CAST, method=Methods.SELF, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY, duration=Durations.PERMANENTLY))
  young_priestess = Card(name="Young Priestess", card_type=CardTypes.MINION, manacost=1, attack=2, health=1,\
                         effect=ChangeStats(value=(ConstantInt(0),ConstantInt(1)), trigger=Triggers.FRIENDLY_END_TURN, method=Methods.RANDOMLY, owner_filter=OwnerFilters.FRIENDLY, target=Targets.MINION, duration=Durations.PERMANENTLY))
  ...
  knife_juggler = Card(name="Knife Juggler", card_type=CardTypes.MINION, manacost=2, attack=3, health=2,\
                       effect=DealDamage(value=ConstantInt(1), trigger=Triggers.FRIENDLY_MINION_SUMMONED, method=Methods.RANDOMLY, target=Targets.MINION_OR_HERO, owner_filter=OwnerFilters.ENEMY))
  mana_addict = Card(name="Mana Addict", card_type=CardTypes.MINION, manacost=2, attack=1, health=3,\
                     effect=ChangeStats(value=(ConstantInt(2), ConstantInt(0)), trigger=Triggers.FRIENDLY_SPELL_CAST, method=Methods.SELF, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY, duration=Durations.TURN))
  mana_wraith = Card(name="Mana Wraith", card_type=CardTypes.MINION, manacost=2, attack=2, health=2,
                effect=ChangeCost(value=ConstantInt(1), target=Targets.MINION, owner_filter=OwnerFilters.ALL, method=Methods.ALL, trigger=Triggers.AURA))
  master_swordsmith = Card(name="Master Swordsmith", card_type=CardTypes.MINION, manacost=2, attack=1, health=3,\
                           effect=ChangeStats(value=(ConstantInt(1), ConstantInt(0)), trigger=Triggers.FRIENDLY_END_TURN, method=Methods.RANDOMLY, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY, duration=Durations.PERMANENTLY))
  pint_sized_summoner = Card(name="Pint-Sized Summoner", card_type=CardTypes.MINION, manacost=2, attack=2, health=2,\
                             effect=ChangeCost(value=IfInt(Equals(MinionsPlayed(OwnerFilters.FRIENDLY), ConstantInt(0)), ConstantInt(-1), ConstantInt(0)), trigger=Triggers.AURA, method=Methods.ALL, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY))
  sunfury_protector = Card(name="Sunfury Protector", card_type=CardTypes.MINION, manacost=2, attack=2, health=3,\
                          effect=GiveAttribute(value=ConstantAttribute(Attributes.TAUNT), method=Methods.ADJACENT, target=Targets.MINION,
  ...
  wild_pyromancer = Card(name="Wild Pyromancer", card_type=CardTypes.MINION, manacost=2, attack=3, health=2,\
                        effect=DualEffectSelf(DealDamage(trigger=Triggers.FRIENDLY_SPELL_CAST, method=Methods.ALL, value=ConstantInt(1), target=Targets.MINION, owner_filter=OwnerFilters.ALL),\
                                              DealDamage(trigger=Triggers.FRIENDLY_SPELL_CAST, method=Methods.SELF, value=ConstantInt(1), target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY)))
  ...
  arcane_golem = Card(name="Arcane Golem", card_type=CardTypes.MINION, manacost=3, attack=4, health=2, attributes=[Attributes.CHARGE],\
                       effect=GainMana(value=ConstantInt(1), method=Methods.ALL, trigger=Triggers.BATTLECRY, owner_filter=OwnerFilters.ENEMY, duration=Durations.PERMANENTLY))
  coldlight_oracle = Card(name="Coldlight Oracle", card_type=CardTypes.MINION, manacost=3, attack=2, health=2, creature_type=CreatureTypes.MURLOC,\
                          effect=DrawCards(value=ConstantInt(2), trigger=Triggers.BATTLECRY, method=Methods.ALL, owner_filter=OwnerFilters.ALL))
  coldlight_seer = Card(name="Coldlight Seer", card_type=CardTypes.MINION, manacost=3, attack=2, health=3, creature_type=CreatureTypes.MURLOC,\
                        effect=ChangeStats(value=(ConstantInt(0), ConstantInt(2)), trigger=Triggers.BATTLECRY, method=Methods.ALL,\
                                           target=Targets.MINION, owner_filter=OwnerFilters.ALL, type_filter=CreatureTypes.MURLOC, duration=Durations.PERMANENTLY))
  demolisher = Card(name="Demolisher", card_type=CardTypes.MINION, manacost=3, attack=1, health=4, creature_type=CreatureTypes.MECH,\
                    effect=DealDamage(value=ConstantInt(2), method=Methods.RANDOMLY, trigger=Triggers.FRIENDLY_UNTAP, target=Targets.MINION_OR_HERO, owner_filter=OwnerFilters.ENEMY))
  ...
  imp_master = Card(name="Imp Master", card_type=CardTypes.MINION, manacost=3, attack=1, health=5,\
                    effect=DualEffectSelf(SummonToken(trigger=Triggers.FRIENDLY_END_TURN, method=Methods.ALL, owner_filter=OwnerFilters.FRIENDLY,\
                                          value=(ConstantInt(1), ConstantCard(Card(name="Imp", card_type=CardTypes.MINION, collectable=False, manacost=1, attack=1, health=1, creature_type=CreatureTypes.DEMON)))),\
                                          DealDamage(value=ConstantInt(1),method=Methods.SELF, trigger=Triggers.FRIENDLY_END_TURN, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY)))
  injured_blademaster = Card(name="Injured Blademaster", card_type=CardTypes.MINION, manacost=3, attack=4, health=7,\
                             effect=DealDamage(value=ConstantInt(4), trigger=Triggers.BATTLECRY, method=Methods.SELF, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY))
  ...
  questing_adventurer = Card(name="Questing Adventurer", card_type=CardTypes.MINION, manacost=3, attack=2, health=2,\
                             effect=ChangeStats(value=(ConstantInt(1), ConstantInt(1)), trigger=Triggers.FRIENDLY_CARD_PLAYED, method=Methods.SELF, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY, duration=Durations.PERMANENTLY))

  # Rare four drops
  ancient_mage = Card(name="Ancient Mage", card_type=CardTypes.MINION, manacost=4, attack=2, health=5,\
                      effect=GiveAttribute(value=ConstantAttribute(Attributes.SPELL_DAMAGE), method=Methods.ADJACENT, trigger=Triggers.BATTLECRY, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY, duration=Durations.PERMANENTLY))
  defender_of_argus = Card(name="Defender of Argus", card_type=CardTypes.MINION, manacost=4, attack=2, health=3,
                          effect=DualEffect(ChangeStats(value=(ConstantInt(1),ConstantInt(1)), method=Methods.ADJACENT, target=Targets.MINION,
                          owner_filter=OwnerFilters.FRIENDLY, duration=Durations.PERMANENTLY, trigger=Triggers.BATTLECRY),
                          GiveAttribute(value=ConstantAttribute(Attributes.TAUNT), method=Methods.ADJACENT, target=Targets.MINION,
                          owner_filter=OwnerFilters.FRIENDLY, duration=Durations.PERMANENTLY, trigger=Triggers.BATTLECRY)))
  twilight_drake = Card(name="Twilight Drake", card_type=CardTypes.MINION, manacost=4, attack=4, health=1, creature_type=CreatureTypes.DRAGON,\
                        effect=ChangeStats(value=(ConstantInt(0), NumCardsInHand(OwnerFilters.FRIENDLY)), method=Methods.SELF, trigger=Triggers.BATTLECRY, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY, duration=Durations.PERMANENTLY))
  violet_teacher = Card(name="Violet Teacher", card_type=CardTypes.MINION, manacost=4, attack=3, health=5,\
                       effect=SummonToken(value=(ConstantInt(1), ConstantCard(Card(name="Violet Apprentice", collectable=False, card_type=CardTypes.MINION, manacost=0, attack=1, health=1))),\
  ...
  abomination = Card(name="Abomination", card_type=CardTypes.MINION, manacost=5, attack=4, health=4, attributes=[Attributes.TAUNT],\
                     effect=DealDamage(value=ConstantInt(2), trigger=Triggers.DEATHRATTLE, method=Methods.ALL, target=Targets.MINION_OR_HERO, owner_filter=OwnerFilters.ALL))
  ...
  gadgetzan_auctioneer = Card(name="Gadgetzan Auctioneer", card_type=CardTypes.MINION, manacost=5, attack=4, health=4,\
                              effect=DrawCards(value=ConstantInt(1), trigger=Triggers.FRIENDLY_SPELL_CAST, owner_filter=OwnerFilters.FRIENDLY, method=Methods.ALL))
  stampeding_kodo = Card(name="Stampeding Kodo", card_type=CardTypes.MINION, manacost=5, attack=3, health=5, creature_type=CreatureTypes.BEAST,\
                          effect=Destroy(value=LessThan(AttackValue(), ConstantInt(3)),method=Methods.RANDOMLY, target=Targets.MINION, trigger=Triggers.BATTLECRY, owner_filter=OwnerFilters.ENEMY))
...
def get_epic_cards():
  ...
  hungry_crab = Card(name="Hungry Crab", card_type=CardTypes.MINION, manacost=1, attack=1, health=2, creature_type=CreatureTypes.BEAST,\
                     effect=DualEffectSelf(Destroy(trigger=Triggers.BATTLECRY, target=Targets.MINION, owner_filter=OwnerFilters.ALL, type_filter=CreatureTypes.MURLOC, method=Methods.TARGETED),\
                                           ChangeStats(value=(ConstantInt(2), ConstantInt(2)),trigger=Triggers.BATTLECRY, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY, method=Methods.SELF, duration=Durations.PERMANENTLY)))
  ...
  doomsayer = Card(name="Doomsayer", card_type=CardTypes.MINION, manacost=2, attack=0, health=7,\
                        effect=DualEffectSelf(Destroy(trigger=Triggers.FRIENDLY_UNTAP, owner_filter=OwnerFilters.ALL, target=Targets.MINION, method=Methods.ALL),\
                                              Destroy(trigger=Triggers.FRIENDLY_UNTAP, owner_filter=OwnerFilters.FRIENDLY, target=Targets.MINION, method=Methods.SELF)))

  # Epic three drops
  big_game_hunter = Card(name="Big Game Hunter", card_type=CardTypes.MINION, manacost=3, attack=4, health=2,\
                          effect=Destroy(value=GreaterThan(AttackValue(), ConstantInt(6)),method=Methods.TARGETED, target=Targets.MINION, trigger=Triggers.BATTLECRY, owner_filter=OwnerFilters.ALL))
  blood_knight = Card(name="Blood Knight", card_type=CardTypes.MINION, manacost=3, attack=3, health=3,\
                      effect=DualEffectSelf(RemoveAttribute(value=ConstantAttribute(Attributes.DIVINE_SHIELD), method=Methods.ALL, trigger=Triggers.BATTLECRY, owner_filter=OwnerFilters.ALL, target=Targets.MINION),\
                                            ChangeStats(value=(Multiply(NumWithAttribute(ConstantAttribute(Attributes.DIVINE_SHIELD), OwnerFilters.ALL), ConstantInt(3)), Multiply(NumWithAttribute(ConstantAttribute(Attributes.DIVINE_SHIELD), OwnerFilters.ALL), ConstantInt(3))),\
  ...
  murloc_warleader = Card(name="Murloc Warleader", card_type=CardTypes.MINION, manacost=3, attack=3, health=3, creature_type=CreatureTypes.MURLOC,\
                          effect=ChangeStats(value=(ConstantInt(2), ConstantInt(1)), method=Methods.ALL, trigger=Triggers.AURA, target=Targets.MINION, owner_filter=OwnerFilters.ALL, type_filter=CreatureTypes.MURLOC))
  southsea_captain = Card(name="Southsea Captain", card_type=CardTypes.MINION, manacost=3, attack=3, health=3, creature_type=CreatureTypes.PIRATE,\
                          effect=ChangeStats(value=(ConstantInt(1), ConstantInt(1)), trigger=Triggers.AURA, method=Methods.ALL, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY, type_filter=CreatureTypes.PIRATE))
  ...
  sea_giant = Card(name="Sea Giant", card_type=CardTypes.MINION, manacost=10, attack=8, health=8,\
                  effect=ChangeCost(value=Multiply(Add(NumOtherMinions(OwnerFilters.ALL), ConstantInt(1)), ConstantInt(-1)), method=Methods.SELF, trigger=Triggers.AURA, owner_filter=OwnerFilters.FRIENDLY, target=Targets.MINION))
  mountain_giant = Card(name="Mountain Giant", card_type=CardTypes.MINION, manacost=12, attack=8, health=8,\
                  effect=ChangeCost(value=Multiply(Add(CardsInHand(OwnerFilters.FRIENDLY), ConstantInt(-1)), ConstantInt(-1)), method=Methods.SELF, trigger=Triggers.AURA, owner_filter=OwnerFilters.FRIENDLY, target=Targets.MINION))
  molten_giant = Card(name="Molten Giant", card_type=CardTypes.MINION, manacost=20, attack=8, health=8,\
                  effect=ChangeCost(value=Multiply(DamageTaken(OwnerFilters.FRIENDLY), ConstantInt(-1)), method=Methods.SELF, trigger=Triggers.AURA, owner_filter=OwnerFilters.FRIENDLY, target=Targets.MINION))
...
def get_legendary_cards():
  ...
  #4 mana is the 2014-launch AND 2021-Classic-format cost (the 5-mana version is the Sept 2014 nerf)
  leeroy_jenkins = Card(name="Leeroy Jenkins", card_type=CardTypes.MINION, manacost=4, attack=6, health=2, attributes=[Attributes.CHARGE],\
...
def get_hunter_cards():
  ...
  hunters_mark = Card(name="Hunter's Mark", card_type=CardTypes.SPELL, manacost=0,\
                      effect=SetStats(value=(None, ConstantInt(1)), method=Methods.TARGETED, target=Targets.MINION, owner_filter=OwnerFilters.ALL))
  arcane_shot = Card(name="Arcane Shot", card_type=CardTypes.SPELL, manacost=1,\
                    effect=DealDamage(value=ConstantInt(2), target=Targets.MINION_OR_HERO, method=Methods.TARGETED, owner_filter=OwnerFilters.ALL))
  timber_wolf = Card(name="Timber Wolf", card_type=CardTypes.MINION, manacost=1, attack=1, health=1, creature_type=CreatureTypes.BEAST,\
                      effect=ChangeStats(value=(ConstantInt(1), ConstantInt(0)), method=Methods.ALL, trigger=Triggers.AURA, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY, type_filter=CreatureTypes.BEAST))
  ...
  starving_buzzard = Card(name="Starving Buzzard", card_type=CardTypes.MINION, manacost=2, attack=2, health=1, creature_type=CreatureTypes.BEAST,\
                          effect=DrawCards(value=ConstantInt(1), trigger=Triggers.FRIENDLY_SAME_TYPE_SUMMONED, method=Methods.ALL, owner_filter=OwnerFilters.FRIENDLY)) 
  animal_companion = Card(name="Animal Companion", card_type=CardTypes.SPELL, manacost=3,\
                          effect=MultiEffectRandom([SummonToken(method=Methods.ALL, owner_filter=OwnerFilters.FRIENDLY, value=(ConstantInt(1), ConstantCard(Card(name="Huffer", collectable=False, card_type=CardTypes.MINION, manacost=3, attack=4, health=2, creature_type=CreatureTypes.BEAST, attributes=[Attributes.CHARGE])))),\
                                                    SummonToken(method=Methods.ALL, owner_filter=OwnerFilters.FRIENDLY, value=(ConstantInt(1), ConstantCard(Card(name="Leokk", collectable=False, card_type=CardTypes.MINION, manacost=3, attack=2, health=4, creature_type=CreatureTypes.BEAST,\
                                                                                                                                                 effect=ChangeStats(value=(ConstantInt(1), ConstantInt(0)), trigger=Triggers.AURA, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY, method=Methods.ALL))))),\
                                                    SummonToken(method=Methods.ALL, owner_filter=OwnerFilters.FRIENDLY, value=(ConstantInt(1), ConstantCard(Card(name="Misha", collectable=False, card_type=CardTypes.MINION, manacost=3, attack=4, health=4, creature_type=CreatureTypes.BEAST, attributes=[Attributes.TAUNT]))))]))
  kill_command = Card(name="Kill Command", manacost=3, card_type=CardTypes.SPELL,\
                      effect=DealDamage(value=IfInt(GreaterThan(NumWithCreatureType(CreatureTypes.BEAST, OwnerFilters.FRIENDLY), ConstantInt(0)),ConstantInt(5), ConstantInt(3)),\
  ...
  houndmaster = Card(name="Houndmaster",card_type=CardTypes.MINION, manacost=4, attack=4, health=3,\
                    effect=DualEffect(ChangeStats(value=(ConstantInt(2), ConstantInt(2)), method=Methods.TARGETED, trigger=Triggers.BATTLECRY, target=Targets.MINION, type_filter=CreatureTypes.BEAST, owner_filter=OwnerFilters.FRIENDLY, duration=Durations.PERMANENTLY),
                                      GiveAttribute(value=ConstantAttribute(Attributes.TAUNT), method=Methods.TARGETED, trigger=Triggers.BATTLECRY, target=Targets.MINION, type_filter=CreatureTypes.BEAST, owner_filter=OwnerFilters.FRIENDLY, duration=Durations.PERMANENTLY)))
  multishot = Card(name="Multi-Shot", card_type=CardTypes.SPELL, manacost=4,\
                  effect=DealDamage(value=ConstantInt(3), method=Methods.RANDOMLY, random_count=2, random_replace=False, target=Targets.MINION, owner_filter=OwnerFilters.ENEMY))
  tundra_rhino = Card(name="Tundra Rhino", card_type=CardTypes.MINION, manacost=5, attack=2, health=5, creature_type=CreatureTypes.BEAST, attributes=[Attributes.CHARGE],\
                      effect=GiveAttribute(value=ConstantAttribute(Attributes.CHARGE), trigger=Triggers.AURA, method=Methods.ALL, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY, type_filter=CreatureTypes.BEAST))

  #Hunter common cards
  explosive_trap = Card(name="Explosive Trap", card_type=CardTypes.SECRET, manacost=2,\
              effect=DealDamage(value=ConstantInt(2), trigger=Triggers.HERO_ATTACKED, method=Methods.ALL, target=Targets.MINION_OR_HERO, owner_filter=OwnerFilters.ENEMY))
  freezing_trap = Card(name="Freezing Trap", card_type=CardTypes.SECRET, manacost=2,\
              effect=DualEffect(ReturnToHand(trigger=Triggers.ENEMY_MINION_ATTACKS, method=Methods.TRIGGERER, target=Targets.MINION, owner_filter=OwnerFilters.ENEMY),\
                                ChangeCost(value=ConstantInt(2), trigger=Triggers.ENEMY_MINION_ATTACKS, method=Methods.TRIGGERER, target=Targets.MINION, owner_filter=OwnerFilters.ENEMY)))
  scavenging_hyena = Card(name="Scavenging Hyena", card_type=CardTypes.MINION, manacost=2, attack=2, health=2, creature_type=CreatureTypes.BEAST,\
                          effect=ChangeStats(value=(ConstantInt(2), ConstantInt(1)), trigger=Triggers.FRIENDLY_SAME_TYPE_DIES, method=Methods.SELF, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY, duration=Durations.PERMANENTLY))
  snipe = Card(name="Snipe", card_type=CardTypes.SECRET, manacost=2,\
              effect=DealDamage(value=ConstantInt(4), trigger=Triggers.ENEMY_MINION_PLAYED, method=Methods.TRIGGERER, target=Targets.MINION, owner_filter=OwnerFilters.ENEMY))
  ...
  unleash_the_hounds = Card(name="Unleash the Hounds", card_type=CardTypes.SPELL, manacost=3,\
                            effect=SummonToken(method=Methods.ALL, owner_filter=OwnerFilters.FRIENDLY,\
                                               value=(NumOtherMinions(OwnerFilters.ENEMY), ConstantCard(Card(name="Hound", collectable=False, card_type=CardTypes.MINION, manacost=1, attack=1, health=1, creature_type=CreatureTypes.BEAST, attributes=[Attributes.CHARGE])))))
  
  #Hunter rare cards
  flare = Card(name="Flare", card_type=CardTypes.SPELL, manacost=1,\
              effect=Cantrip(DualEffectSecrets(RemoveAttribute(value=ConstantAttribute(Attributes.STEALTH), target=Targets.MINION, owner_filter=OwnerFilters.ALL, method=Methods.ALL),\
  ...
  eaglehorn_bow = Card(name="Eaglehorn Bow", card_type=CardTypes.WEAPON, manacost=3, attack=3, health=2,\
                      effect=ChangeStats(value=(ConstantInt(0), ConstantInt(1)), trigger=Triggers.ANY_SECRET_REVEALED, method=Methods.SELF, target=Targets.WEAPON, owner_filter=OwnerFilters.FRIENDLY, duration=Durations.PERMANENTLY))
  explosive_shot = Card(name="Explosive Shot", card_type=CardTypes.SPELL, manacost=5,\
                        effect=DualEffect(DealDamage(method=Methods.TARGETED, value=ConstantInt(3), target=Targets.MINION, owner_filter=OwnerFilters.ENEMY),\
                                          DealDamage(method=Methods.TARGETED, value=ConstantInt(2), target=Targets.MINION, owner_filter=OwnerFilters.ENEMY, hits_adjacent=True)))
...
def get_mage_cards():
  ...
  arcane_missiles = Card(name="Arcane Missiles", manacost=1, card_type=CardTypes.SPELL,\
                         effect=DealDamage(value=ConstantInt(1), random_count=3, method=Methods.RANDOMLY, target=Targets.MINION_OR_HERO, owner_filter=OwnerFilters.ENEMY))
  mirror_image = Card(name="Mirror Image", manacost=1, card_type=CardTypes.SPELL,\
                          effect=SummonToken(method=Methods.ALL, owner_filter=OwnerFilters.FRIENDLY,\
                                                value=(ConstantInt(2), ConstantCard(Card(name="Mirror Image Token", collectable=False, card_type=CardTypes.MINION, manacost=0, attack=0, health=2, attributes=[Attributes.TAUNT])))))
  arcane_explosion = Card(name="Arcane Explosion", manacost=2, card_type=CardTypes.SPELL,\
                          effect=DealDamage(value=ConstantInt(1), target=Targets.MINION, method=Methods.ALL, owner_filter=OwnerFilters.ENEMY))
  frostbolt = Card(name="Frostbolt", manacost=2, card_type=CardTypes.SPELL,\
                   effect=DualEffect(DealDamage(value=ConstantInt(3), target=Targets.MINION_OR_HERO, method=Methods.TARGETED, owner_filter=OwnerFilters.ALL),
                                     GiveAttribute(value=ConstantAttribute(Attributes.FROZEN), target=Targets.MINION_OR_HERO, method=Methods.TARGETED, owner_filter=OwnerFilters.ALL, duration=Durations.PERMANENTLY)))
  arcane_intellect = Card(name="Arcane Intellect", card_type=CardTypes.SPELL, manacost=3,
                          effect=DrawCards(value=ConstantInt(2), owner_filter=OwnerFilters.FRIENDLY, method=Methods.ALL))
  frost_nova = Card(name="Frost Nova", card_type=CardTypes.SPELL, manacost=3,\
                    effect=GiveAttribute(value=ConstantAttribute(Attributes.FROZEN), method=Methods.ALL, owner_filter=OwnerFilters.ENEMY, target=Targets.MINION, duration=Durations.PERMANENTLY))
  fireball = Card(name="Fireball", card_type=CardTypes.SPELL, manacost=4, effect=DealDamage(
    value=ConstantInt(6), method=Methods.TARGETED, target=Targets.MINION_OR_HERO, owner_filter=OwnerFilters.ALL))
  polymorph = Card(name="Polymorph", card_type=CardTypes.SPELL, manacost=4,\
                  ...
                  value=(ConstantInt(1), ConstantCard(Card(name="Sheep", collectable=False, card_type=CardTypes.MINION, manacost=0, attack=1, health=1, creature_type=CreatureTypes.BEAST)))))
  ...
  flamestrike = Card(name="Flamestrike", card_type=CardTypes.SPELL, manacost=7,\
                    effect=DealDamage(value=ConstantInt(4), target=Targets.MINION, method=Methods.ALL, owner_filter=OwnerFilters.ENEMY))
  
  # Mage common cards
  ice_lance = Card(name="Ice Lance", card_type=CardTypes.SPELL, manacost=1,\
                  effect=DualEffect(DealDamage(value=IfInt(TargetFrozen(), ConstantInt(4), ConstantInt(0)), method=Methods.TARGETED, target=Targets.MINION_OR_HERO, owner_filter=OwnerFilters.ALL),\
                        GiveAttribute(value=ConstantAttribute(Attributes.FROZEN), method=Methods.TARGETED, target=Targets.MINION_OR_HERO, owner_filter=OwnerFilters.ALL, duration=Durations.PERMANENTLY)))
  mana_wyrm = Card(name="Mana Wyrm", card_type=CardTypes.MINION, manacost=1, attack=1, health=3,\
                  effect=ChangeStats(value=(ConstantInt(1), ConstantInt(0)), trigger=Triggers.FRIENDLY_SPELL_CAST, method=Methods.SELF, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY, duration=Durations.PERMANENTLY))
  sorcerers_apprentice = Card(name="Sorcerer's Apprentice", card_type=CardTypes.MINION, manacost=2, attack=3, health=2,\
                              effect=ChangeCost(value=ConstantInt(-1), trigger=Triggers.AURA, method=Methods.ALL, target=Targets.SPELL, owner_filter=OwnerFilters.FRIENDLY))
  ice_barrier = Card(name="Ice Barrier", card_type=CardTypes.SECRET, manacost=3,\
                     effect=GainArmor(value=ConstantInt(8), trigger=Triggers.HERO_ATTACKED, method=Methods.ALL, owner_filter=OwnerFilters.FRIENDLY))
  mirror_entity = Card(name="Mirror Entity", card_type=CardTypes.SECRET, manacost=3,\
                        effect=SummonToken(trigger=Triggers.ENEMY_MINION_PLAYED, value=(ConstantInt(1), Target()), method=Methods.TRIGGERER, owner_filter=OwnerFilters.FRIENDLY))
  cone_of_cold = Card(name="Cone of Cold", card_type=CardTypes.SPELL, manacost=4,\
                      effect=DualEffect(GiveAttribute(value=ConstantAttribute(Attributes.FROZEN), method=Methods.TARGETED, target=Targets.MINION, owner_filter=OwnerFilters.ALL, hits_adjacent=True, duration=Durations.PERMANENTLY),\
                                        DealDamage(value=ConstantInt(1), method=Methods.TARGETED, target=Targets.MINION, owner_filter=OwnerFilters.ALL, hits_adjacent=True)))
  ...
  blizzard = Card(name="Blizzard", card_type=CardTypes.SPELL, manacost=6,\
                  effect=DualEffect(DealDamage(value=ConstantInt(2), method=Methods.ALL, target=Targets.MINION, owner_filter=OwnerFilters.ENEMY),\
                           GiveAttribute(value=ConstantAttribute(Attributes.FROZEN), method=Methods.ALL, target=Targets.MINION, owner_filter=OwnerFilters.ENEMY, duration=Durations.PERMANENTLY)))

  # Mage epic cards
  ice_block = Card(name="Ice Block", card_type=CardTypes.SECRET, manacost=3,\
                    effect=GiveAttribute(trigger=Triggers.LETHAL_DAMAGE, value=ConstantAttribute(Attributes.IMMUNE), method=Methods.ALL, target=Targets.HERO, owner_filter=OwnerFilters.FRIENDLY, duration=Durations.TURN))
  spellbender = Card(name="Spellbender", card_type=CardTypes.SECRET, manacost=3,\
                      effect=RedirectToToken(value=(ConstantInt(1), ConstantCard(Card(name="Spellbender Token", collectable=False, card_type=CardTypes.MINION, manacost=0, attack=1, health=3))),\
...
def get_warrior_cards():
  ...
  execute = Card(name="Execute", card_type=CardTypes.SPELL, manacost=1,\
                 effect=Destroy(value=Damaged(), target=Targets.MINION, owner_filter=OwnerFilters.ENEMY, method=Methods.TARGETED))
  whirlwind = Card(name="Whirlwind", card_type=CardTypes.SPELL, manacost=1,\
                   effect=DealDamage(value=ConstantInt(1), method=Methods.ALL, target=Targets.MINION, owner_filter=OwnerFilters.ALL))
  cleave = Card(name="Cleave", card_type=CardTypes.SPELL, manacost=2,\
                effect=DealDamage(value=ConstantInt(2), random_count=2, random_replace=False, method=Methods.RANDOMLY, target=Targets.MINION, owner_filter=OwnerFilters.ENEMY))
  ...
  heroic_strike = Card(name="Heroic Strike", card_type=CardTypes.SPELL, manacost=2,\
                      effect=ChangeStats(value=(ConstantInt(4), ConstantInt(0)), method=Methods.ALL, target=Targets.HERO, owner_filter=OwnerFilters.FRIENDLY, duration=Durations.TURN))
  charge = Card(name="Charge", card_type=CardTypes.SPELL, manacost=3,\
                effect=DualEffect(GiveAttribute(value=ConstantAttribute(Attributes.CHARGE), method=Methods.TARGETED, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY, duration=Durations.PERMANENTLY),\
                                  ChangeStats(value=(ConstantInt(2), ConstantInt(0)), method=Methods.TARGETED, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY, duration=Durations.PERMANENTLY)))
  shield_block = Card(name="Shield Block", card_type=CardTypes.SPELL, manacost=3,\
                      effect=Cantrip(GainArmor(value=ConstantInt(5), method=Methods.ALL, owner_filter=OwnerFilters.FRIENDLY)))
  warsong_commander = Card(name="Warsong Commander", card_type=CardTypes.MINION, manacost=3, attack=2, health=3,\
                          effect=GiveAttribute(trigger=Triggers.FRIENDLY_LESS_THAN_FOUR_ATTACK_SUMMONED, value=ConstantAttribute(Attributes.CHARGE), method=Methods.TRIGGERER, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY, duration=Durations.PERMANENTLY))
  ...
  inner_rage = Card(name="Inner Rage", card_type=CardTypes.SPELL, manacost=0,\
                    effect=DualEffect(DealDamage(value=ConstantInt(1), target=Targets.MINION, method=Methods.TARGETED, owner_filter=OwnerFilters.ALL),\
                                      ChangeStats(value=(ConstantInt(2), ConstantInt(0)), target=Targets.MINION, method=Methods.TARGETED, owner_filter=OwnerFilters.ALL, duration=Durations.PERMANENTLY)))
  battle_rage = Card(name="Battle Rage", card_type=CardTypes.SPELL, manacost=2,\
                    effect=DrawCards(value=Add(NumDamaged(OwnerFilters.FRIENDLY), IfInt(GreaterThan(DamageTaken(OwnerFilters.FRIENDLY), ConstantInt(0)), ConstantInt(1), ConstantInt(0))),\
  ...
  cruel_taskmaster = Card(name="Cruel Taskmaster", card_type=CardTypes.MINION, manacost=2, attack=2, health=2,\
                    effect=DualEffect(DealDamage(value=ConstantInt(1), trigger=Triggers.BATTLECRY, target=Targets.MINION, method=Methods.TARGETED, owner_filter=OwnerFilters.ALL),\
                                      ChangeStats(value=(ConstantInt(2), ConstantInt(0)), target=Targets.MINION, method=Methods.TARGETED, owner_filter=OwnerFilters.ALL, duration=Durations.PERMANENTLY)))
  rampage = Card(name="Rampage", card_type=CardTypes.SPELL, manacost=2,\
                effect=ChangeStats(value=(ConstantInt(3), ConstantInt(3)), method=Methods.TARGETED, target=Targets.MINION, owner_filter=OwnerFilters.ALL, duration=Durations.PERMANENTLY, dynamic_filter=Damaged()))
  slam = Card(name="Slam", card_type=CardTypes.SPELL, manacost=2,\
              effect=DualEffect(DealDamage(value=ConstantInt(2), method=Methods.TARGETED, target=Targets.MINION, owner_filter=OwnerFilters.ALL),\
                                DrawCards(value=IfInt(TargetAlive(), ConstantInt(1), ConstantInt(0)), owner_filter=OwnerFilters.FRIENDLY, method=Methods.ALL)))
  arathi_weaponsmith = Card(name="Arathi Weaponsmith", card_type=CardTypes.MINION, manacost=4, attack=3, health=3,\
                            effect=SummonToken(trigger=Triggers.BATTLECRY, method=Methods.ALL, owner_filter=OwnerFilters.FRIENDLY,\
                            value=(ConstantInt(1), ConstantCard(Card(name="Battle Axe", collectable=False, card_type=CardTypes.WEAPON, manacost=1, attack=2, health=2)))))

  #Warrior rare cards
  upgrade = Card(name="Upgrade!", card_type=CardTypes.SPELL, manacost=1,\
                  effect=DynamicChoice(HasWeapon(OwnerFilters.FRIENDLY),
                                       ChangeStats(value=(ConstantInt(1), ConstantInt(1)), target=Targets.WEAPON, owner_filter=OwnerFilters.FRIENDLY, method=Methods.ALL, duration=Durations.PERMANENTLY),\
                                       SummonToken(trigger=Triggers.BATTLECRY, method=Methods.ALL, owner_filter=OwnerFilters.FRIENDLY,\
                                                   value=(ConstantInt(1), ConstantCard(Card(name="Heavy Axe", collectable=False, card_type=CardTypes.WEAPON, manacost=1, attack=1, health=3))))))
  armorsmith = Card(name="Armorsmith", card_type=CardTypes.MINION, manacost=2, attack=1, health=4,\
                    effect=GainArmor(value=ConstantInt(1), trigger=Triggers.FRIENDLY_MINION_DAMAGED, method=Methods.ALL, owner_filter=OwnerFilters.FRIENDLY))
  commanding_shout = Card(name="Commanding Shout", card_type=CardTypes.SPELL, manacost=2,\
                          effect=Cantrip(GiveAttribute(value=ConstantAttribute(Attributes.MINIONS_UNKILLABLE), method=Methods.ALL, target=Targets.HERO, owner_filter=OwnerFilters.FRIENDLY, duration=Durations.TURN)))
  frothing_berserker = Card(name="Frothing Berserker", card_type=CardTypes.MINION, manacost=3, attack=2, health=4,\
                            effect=ChangeStats(value=(ConstantInt(1), ConstantInt(0)), trigger=Triggers.ANY_MINION_DAMAGED, method=Methods.SELF, target=Targets.MINION, owner_filter=OwnerFilters.FRIENDLY, duration=Durations.PERMANENTLY))
  mortal_strike = Card(name="Mortal Strike", card_type=CardTypes.SPELL, manacost=4,\
                        effect=DealDamage(value=IfInt(GreaterThan(DamageTaken(OwnerFilters.FRIENDLY), ConstantInt(17)), ConstantInt(6), ConstantInt(4)),\
                                          method=Methods.TARGETED, target=Targets.MINION_OR_HERO, owner_filter=OwnerFilters.ALL))
  ...
  brawl = Card(name="Brawl", card_type=CardTypes.SPELL, manacost=5,\
              effect=DualEffectBoard(GiveAttribute(value=ConstantAttribute(Attributes.BRAWL_PROTECTION), method=Methods.RANDOMLY, target=Targets.MINION, owner_filter=OwnerFilters.ALL, duration=Durations.TURN),\
                                     DualEffect(Destroy(value=Not(SourceHasAttribute(ConstantAttribute(Attributes.BRAWL_PROTECTION))), method=Methods.ALL, target=Targets.MINION, owner_filter=OwnerFilters.ALL),\
  ...
  grommash_hellscream = Card(name="Grommash Hellscream", card_type=CardTypes.MINION, manacost=8, attack=4, health=9, attributes=[Attributes.CHARGE],\
                             condition=Condition(requirement=Damaged(), result={'temp_attack': 6}))
...
def get_test_cards():
  all_dam = Card("All Damage", card_type=CardTypes.SPELL, manacost=0,
           effect=DealDamage(value=ConstantInt(3), method=Methods.ALL, target=Targets.MINION_OR_HERO,
                   owner_filter=OwnerFilters.ALL)
           )
  ...
  battlecry_weapon = Card("Battlecry Weapon", card_type=CardTypes.WEAPON, manacost=1, attack=3, health=2,
              effect=DealDamage(value=ConstantInt(1), method=Methods.ALL, target=Targets.MINION_OR_HERO, owner_filter=OwnerFilters.ALL, trigger=Triggers.BATTLECRY))
  ...
  battlecry_reduce_cost = Card("Battlecry Reduce Cost", card_type=CardTypes.MINION, manacost=0, attack=0, health=1,
                 effect=ChangeCost(value=ConstantInt(1), target=Targets.MINION_OR_SPELL, method=Methods.ALL, owner_filter=OwnerFilters.ENEMY, trigger=Triggers.BATTLECRY))
  gain_perm_mana = Card("Gain Perm Mana", card_type=CardTypes.SPELL, manacost=0,\
                        effect=GainMana(value=ConstantInt(1), owner_filter=OwnerFilters.FRIENDLY, method=Methods.ALL, duration=Durations.PERMANENTLY))
  summon_none = Card("Summon None", card_type=CardTypes.SPELL, manacost=1,\
                      effect=SummonToken(method=Methods.ALL, owner_filter=OwnerFilters.FRIENDLY, value=(ConstantInt(1), Source())))

  test_cards = [all_dam, generic_weapon, battlecry_weapon,
          windfury_weapon, battlecry_reduce_cost, gain_perm_mana, summon_none]
  return test_cards
...
def _build_pool(set_names, random_state):
  ...
  if CardSets.NAXX_NEUTRAL in set_names:
    pool.extend(get_naxx_neutral_cards())
  if CardSets.NAXX_HUNTER in set_names:
    pool.extend(get_naxx_hunter_cards())
  if CardSets.NAXX_MAGE in set_names:
    pool.extend(get_naxx_mage_cards())
  if CardSets.NAXX_WARRIOR in set_names:
    pool.extend(get_naxx_warrior_cards())
  return pool


def _apply_card_patches(pool, card_patches):
  """Historical patch simulation (e.g. the 22 Sept 2014 nerf). card_patches
  maps card name -> {"manacost"/"attack"/"health": value}. Pool cards are
  shared prototypes, so patched cards are DEEPCOPIED before mutation - never
  patch a cached card in place. original_* are updated too so Card.reset()
  between games keeps the patched values."""
  patched_pool = []
  for card in pool:
    if card.name in card_patches:
      card = deepcopy(card)
      patch = card_patches[card.name]
      if "manacost" in patch:
        card.manacost = card.original_manacost = patch["manacost"]
      if "attack" in patch:
        card.attack = card.original_attack = patch["attack"]
      if "health" in patch:
        card.health = card.max_health = card.original_health = patch["health"]
    patched_pool.append(card)
  return patched_pool


_pool_cache = {}

def build_pool(set_names, random_state, card_patches=None):
  ...
  if CardSets.RANDOM_CARDS in set_names:
    pool = _build_pool(set_names, random_state)
    return _apply_card_patches(pool, card_patches) if card_patches else pool
  key = tuple(set_names)
  if card_patches:
    key = key + tuple(sorted((name, tuple(sorted(patch.items()))) for name, patch in card_patches.items()))
  if key not in _pool_cache:
    pool = _build_pool(set_names, random_state)
    if card_patches:
      pool = _apply_card_patches(pool, card_patches)
    _pool_cache[key] = pool
  return list(_pool_cache[key])


#the real 22 Sept 2014 balance patch, for historical nerf-response experiments
SEPT_2014_NERF_PATCHES = {
  "Starving Buzzard": {"manacost": 5, "attack": 3, "health": 2},
  "Leeroy Jenkins": {"manacost": 5},
}
